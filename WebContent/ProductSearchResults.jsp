...
<table width="700px"
         ...
         <c:forEach items="${piList}" var="list">
           <tr>
                ...
                <td><form action=ProductSearchResults method="post"><input type="hidden" name="productId" value="${list.getProductId()}"><button name="order" type="submit" value="${list.getProductName()}">view product</button></form></td>
